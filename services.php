	...
	<?php include "components/php/navbar.php"; ?>
		...
		<div class="col-md-3">
		  <div id="content">
		    ...
		    <p>Junto a mi equipo en <a href="http://tierraviva.tv">TierraViva.tv</a> , realizamos las ediciones de video orientados a proyectos educativos y de divulgación de la Naturaleza en multiplataforma y de productos audiovisuales para centros de interpretación.</p>
<p><a class="btn" href="collections-index.php"></a></p>
	          </div>
		</div>
	      </div>
